...
| Monochrome CTA buttons                                                             | done     | Landing CTAs use dedicated black-monochrome tokens (`--color-cta-*`: primary charcoal / secondary gray-100), independent of the blue `--color-accent` that still drives links, focus rings, and callouts. CTA tokens are theme-independent (same value in light + dark). |
