# ROADMAP — the 10x plan (first edition, ARCHIVED)

> **Archived 2026-07-03.** This edition is essentially complete — Tiers A/C/D,
> S1–S6, and U1–U8 all shipped between 0.4.0 and 0.21.0; the few deferred
> slices were carried into the live plan. **The current roadmap is
> [`ROADMAP.md`](./ROADMAP.md) (second edition).** This file stays as the
> historical record; item IDs referenced elsewhere (B2, B6, U2, …) resolve here.
