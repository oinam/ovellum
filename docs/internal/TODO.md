...
- Toggle icons: auto-theme glyph swapped from Lucide `monitor` (read too literal / computer-y) → `eclipse` (circle with crescent — closer to a yin-yang and quieter as UI furniture).
